...
class CWavefrontObj {
	...
	DirectX::BoundingSphere m_spherebox; //境界球の情報
	bool     m_bCrack;       // 割れ目
public:
	CWavefrontObj() : m_pD3DDevice(NULL), m_pD3DDeviceContext(NULL), m_pVerBuffer(NULL), m_pIdxBuffer(NULL), m_pIdxAdjBuffer(NULL), m_countGroup(0), m_countVBuffer(0), m_countIBuffer(0), m_bCrack(true) {}
